...
Flow:
    ...
    -> LLM: OpenAI API -> explanation with DISCLAIMER
"""
...
from src.config import (
    ...
    CLASS_NAMES, HAM10000_CLASSES, OPENAI_API_KEY
)
...
class SkinLesionPipeline:
    ...
    def _load_llm(self):
        if self._llm is None and self.use_llm and OPENAI_API_KEY:
    ...
    def predict(
        ...
        if generate_explanation and self.use_llm and OPENAI_API_KEY and symptom_text:
            self._load_llm()
